                    ...
                    if (res?.status == 204) {
                        swal(
                            ...
                            "You have successfully invited '" +
                                email +
                                " . They should receive an email with a link to complete their registration.",
                            "success"
                        ).then(
                            navigateWithRefreshToken("/admin_board/researchers").then((res) =>
                                res?.status == 200 ? (userInfo = res.data) : (userInfo = null)
                            )
                        );
                    } else {
